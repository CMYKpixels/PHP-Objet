...
<div class="container">
    <img src="https://www.gravatar.com/avatar/<?=gravatar($post->getEmailUser())?>" alt="..." class="img-circle pull-left">
    <div >
...
<div class="row">
    ...
    <div class="col-sm-1">
        <div class="thumbnail">
            <img src="https://www.gravatar.com/avatar/<?=gravatar($c->getEmail())?>" class="img-responsive user-photo">
        </div>
    </div>
    ...
    <div class="col-sm-11">
        <div class="panel panel-default">
            <div class="panel-heading">
                <strong><?=$c->getUsername()?></strong> <span class="text-muted">A commenté il y a <?=time_elapsed_string($c->getDateCom())?> jours</span>
            </div>
