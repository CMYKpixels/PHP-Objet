...
$successDelete = !empty($_GET['success_delete']) ? $_GET['success_delete'] : false;
?>
    <html>
      <head>
      ...
      <body>
        ...
        <?php if(!empty($successDelete)): ?>
            <h2 style="color: green;">Étudiants correctement effacés</h2>
        <?php endif; ?>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?=$s['email']?></td>
                  <td><?=$s['langue']?></td>
                  <td><input type="checkbox" value="<?=$s['id']?>" name="delete[]" /></td>
                </tr>
              <?php endforeach; ?>
              </tbody>
            </table>
